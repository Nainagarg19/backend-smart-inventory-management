...
public class Return {
	...
	public Return(int returnId, String item_name, String capacity, String manager, Date date_of_del,
			boolean date_of_return, int godown_id, int quantity, int invoice_no, String return_by, int reciept_no,
			int bill_value, Date return_date, String checked_by) {
		super();
	...
	public String toString() {
		return "Return [returnId=" + returnId + ", item_name=" + item_name + ", capacity=" + capacity + ", manager="
				+ manager + ", date_of_del=" + date_of_del + ", date_of_return=" + date_of_return + ", godown_id="
				+ godown_id + ", quantity=" + quantity + ", invoice_no=" + invoice_no + ", return_by=" + return_by
				+ ", reciept_no=" + reciept_no + ", bill_value=" + bill_value + ", return_date=" + return_date
